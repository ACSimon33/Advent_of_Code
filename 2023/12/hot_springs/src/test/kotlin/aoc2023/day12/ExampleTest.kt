...
class ExampleTest {
    ...
    @Test
    fun task1() {
        assertEquals(app.sumOfSpringConfigurations(1), 21, "Example result for task 1 is wrong")
    }

    /** Second task test */
    @Test
    fun task2() {
        assertEquals(app.sumOfSpringConfigurations(5), 525152, "Example result for task 2 is wrong")
    }
}
