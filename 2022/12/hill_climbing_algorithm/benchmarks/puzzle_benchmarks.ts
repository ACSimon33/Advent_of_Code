...
export const suite = benny.suite(
  ...
  // Benchmark of part 1
  benny.add('Task 1', () => {
    hill_climbing_algorithm.shortest_path(INPUT_FILENAME);
  }),

  // Benchmark of part 2
  benny.add('Task 2', () => {
    hill_climbing_algorithm.shortest_path_overall(INPUT_FILENAME);
  }),
  ...
  benny.save({
    file: 'results',
    folder: '../../build/benchmarks/12/hill_climbing_algorithm',
    details: true,
    format: 'json'
  })
);
