...
fn dijkstra_less_than(
    comptime T: type,
    comptime Context: type,
) (fn (Context, *DijkstraNode(T), *DijkstraNode(T)) Order) {
    return struct {
        fn less_than(context: Context, a: *DijkstraNode(T), b: *DijkstraNode(T)) Order {
            _ = context;
